...
La explicación se guarda como un solo string con formato markdown. Un parrafo inicial con la respuesta y la razón, seguido de bullets con detalles.

**Formato en el JSON**:
```json
"explicación": "Parrafo corto con la respuesta correcta y por que.\n\n- Opciones incorrectas: por que A y C estan mal\n- Conexión: dato relacionado con otro tema o regla vinculada\n- Excepción: caso especial o excepción a la regla (si aplica)"
```
...
## Reglas del formato
- **Parrafo inicial**: 1-2 frases. Respuesta correcta + razón principal.
