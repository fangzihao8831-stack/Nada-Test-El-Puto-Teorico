...
|--------|------------|---------|
| Artículo (El/La/Los/Las/Un/Una) | ~25% | "El conductor de un turismo..." |
| En... (ubicacion/situación) | ~13% | "En una autopista..." |
...
- **Coma + ¿**: Transicion suave — "Si circula de noche por una carretera sin iluminación**,** ¿qué luces debe usar?"
...
- Los absolutos pueden aparecer en CUALQUIER opción, correcta o incorrecta
- Las opciones incorrectas deben sonar plausibles y razonables, no extremas ni absurdas
- **Distribuir absolutos de forma impredecible**: a veces la correcta es el absoluto simple, a veces la incorrecta

### Ejemplos reales del DGT donde el absoluto ES correcto:
- "¿Es obligatorio detenerse ante barreras en movimiento?" → **"Sí."** (1 palabra, absoluto, correcta)
- "¿Está permitido circular sin silenciador?" → **"No."** (1 palabra, absoluto, correcta)
- "¿Está obligado a ceder el paso al tranvía?" → **"Sí."** (correcta es el absoluto simple)
- "Leer un periódico mientras conduce, ¿es un riesgo?" → **"Sí."** (correcta, las opciones largas son las incorrectas)
...
| **Adelantamiento** | 3.5% | Cuando/donde, ciclistas, línea continua |
| **Mantenimiento / ITV** | 3% | Neumáticos, frenos, inspeccion técnica |
...
- Velocidades máximas/mínimas según via y vehículo
...
- Detalles técnicos de implementación (que datos envia el eCall, cuantos segundos graba el EDR)
